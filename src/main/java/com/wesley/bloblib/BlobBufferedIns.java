...
public class BlobBufferedIns extends InputStream {
     ...
     * @throws BfsException
     */
    public synchronized final int updateCentralBuffer(int bufferOffset, int dwOffset, int len) throws BfsException {
	...
	public synchronized final byte[] downloadBlobChunk (int offset, long len) throws BfsException {
